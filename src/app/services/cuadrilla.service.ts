...
export class CuadrillaService {
  ...
  crearCuadrilla(data: { nombre: string; responsable: string; distrito: string; zona_asignada?: string }): Observable<boolean> {
  ...
  actualizarCuadrilla(id: number, data: { nombre?: string; responsable?: string; distrito?: string; zona_asignada?: string; estado?: string }): Observable<boolean> {
